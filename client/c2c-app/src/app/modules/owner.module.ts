...
@NgModule({
  declarations: [AddCarComponent,ManageCarComponent,ListBookingComponent,ManageBookingComponent,ManageProfileComponent,OTPComponent,RegisterOTPComponent,ManageProfileImageComponent],
  imports: [
    CommonModule,
    ReactiveFormsModule,
