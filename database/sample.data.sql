...
#insert into car
INSERT INTO `c2cdb`.`car` (`car_id`, `owner_id`, `status`, `vehicle_regis_no`, `rental_rate`, `country_code`, `city`, `images_keys`, `year`, `maker`, `model`, `trim`, `like_count`, `review_count`, `created_by`, `created_date`, `last_updated_by`, `last_updated_date`) VALUES ('10000', '10000', 'A', 'SXX1234B', '40', 'SG', 'Singapore', '' '1990', 'hyndai', 'model', 'trimed data', '0', '0', '1', '1', '1', '1');
INSERT INTO `c2cdb`.`car` (`car_id`, `owner_id`, `status`, `vehicle_regis_no`, `rental_rate`, `country_code`, `city`, `images_keys`, `year`, `maker`, `model`, `trim`, `like_count`, `review_count`, `created_by`, `created_date`, `last_updated_by`, `last_updated_date`) VALUES ('10001', '10000', 'A', 'SXX1234C', '40', 'SG', 'Singapore', '', '1990', 'hyndai', 'model', 'trimed data', '0', '0', '1', '1', '1', '1');
